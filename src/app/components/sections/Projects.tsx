...
const projects: Project[] = [
  {
    ...
    index: '01',
    name: 'SMugFlex 2.0',
    tagline: 'All-in-one school management platform — results, CBT, fees, attendance & staff',
    overview: 'SMugFlex 2.0 is the all-in-one school management platform for modern Nigerian schools. Handles result compilation, CBT exams, fee collection, attendance tracking, and staff management. PWA with Capacitor (offline support), free first term trial.',
    problem: 'Schools needed a single platform to replace fragmented tools for results, CBT exams, fee collection, and attendance — with reliable offline and mobile support.',
    solution: 'Built a multi-school platform with React + TypeScript + React Router + Framer Motion, Capacitor PWA (offline, push notifications, biometric auth), and Tailwind CSS. Features results management, CBT exams, fee collection, attendance, report cards, and parent portal.',
    tech: ['React', 'TypeScript', 'Capacitor', 'PWA', 'Framer Motion', 'Tailwind CSS'],
    outcome: 'Live at smugflex.name.ng — serving schools with results, CBT, fees and attendance in one place. Also deployed at smug-flex-multi-school-o3to.vercel.app.',
    image: '/smugflex-v2.jpg',
    github: 'https://github.com/Hoseaurbanus/SmugFlex-Multi-School-',
    demo: 'https://smugflex.name.ng/',
  },
  {
    id: 2,
    index: '02',
